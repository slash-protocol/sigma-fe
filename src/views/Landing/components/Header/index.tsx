...
import "./header.scss";
import { ReactComponent as SigmaDaoIcon } from "../../../../assets/Sigma.svg";
            ...
            {({ TransitionProps }) => (
              <Fade {...TransitionProps} timeout={200}>
                <div className="tooltip">
                  <Link className="tooltip-item" href="https://github.com/SigmaDao" target="_blank">
                    <SvgIcon color="primary" component={GitHub} />
                    <p>GitHub</p>
                  </Link>
                  <Link className="tooltip-item" href="https://twitter.com/SIGMAenerous" target="_blank">
