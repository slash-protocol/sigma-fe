...
function Calculator() {
  ...
  const calcInitialInvestment = () => {
    const ssigma = Number(memoAmount) || 0;
    const price = parseFloat(priceAtPurchase) || 0;
    const amount = ssigma * price;
          ...
          <Grid className="calculator-card-grid" container direction="column" spacing={2}>
            <Grid item>
              <div className="calculator-card-header">
                ...
                <p className="calculator-card-header-subtitle">Estimate how much you get Based...</p>
              </div>
            </Grid>
            <Grid item>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="calculator-card-apy">
                      <p className="calculator-card-metrics-title">SIGMA Price</p>
                  ...
                  <Grid item xs={6} sm={4} md={4} lg={4}>
                    <div className="calculator-card-index">
                      <p className="calculator-card-metrics-title">Your SIGMA Balance</p>
                      <p className="calculator-card-metrics-value">
                        {isAppLoading ? <Skeleton width="100px" /> : <>{trimmedMemoBalance} SIGMA</>}
                      </p>
                    </div>
                  </Grid>
                </Grid>
            ...
            <div className="calculator-card-area">
              <div>
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                      <div className="calculator-card-action-area-inp-wrap">
                        <p className="calculator-card-action-area-inp-wrap-title">SIGMA Amount</p>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                    ...
                    <Grid item xs={12} sm={6}>
                      <div className="calculator-card-action-area-inp-wrap">
                        <p className="calculator-card-action-area-inp-wrap-title">SIGMA price at purchase ($)</p>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                          className="calculator-card-action-input"
                    ...
                    <Grid item xs={12} sm={6}>
                      <div className="calculator-card-action-area-inp-wrap">
                        <p className="calculator-card-action-area-inp-wrap-title">Future SIGMA market price ($)</p>
                        <OutlinedInput
                          type="number"
                          placeholder="Amount"
                          className="calculator-card-action-input"
                ...
                <div className="calculator-user-data">
                  ...
                  <div className="data-row">
                    <p className="data-row-name">SIGMA rewards estimation</p>
                    <p className="data-row-value">
                      {isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} SIGMA</>}
                    </p>
                  </div>
                  <div className="data-row">
