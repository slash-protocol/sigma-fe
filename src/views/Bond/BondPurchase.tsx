...
import { OutlinedInput, InputAdornment, Slide, FormControl } from "@material-ui/core";
    ...
    <Box display="flex" flexDirection="column">
      <Box display="flex" justifyContent="space-around" flexWrap="wrap">
        ...
        {hasAllowance() || useAvax ? (
          ...
          >
            <p>{txnButtonText(pendingTransactions, "bond_" + bond.name, "Sigma Me")}</p>
          </div>
        ) : (
          <div
            className="transaction-button bond-approve-btn"
        ...
        {!hasAllowance() && !useAvax && (
          <div className="help-text">
            <p className="help-text-desc">
              Note: The "Approve" transaction is only needed when sigmaging yourself for the first sigma; subsequent
              sigmas only requires you to perform the "Sigma Me" transaction.
            </p>
          </div>
        )}
      </Box>
        ...
        <Box className="bond-data">
          ...
          <div className="data-row">
            ...
            <p className="price-data bond-balance-title">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4)} SIGMA`}
            </p>
          </div>
          ...
          <div className={`data-row`}>
            ...
            <p className="price-data bond-balance-title">
              {isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} SIGMA`}
            </p>
          </div>
          ...
          <div className="data-row">
            ...
            <p className="bond-balance-title">0.01 SIGMA</p>
          </div>
